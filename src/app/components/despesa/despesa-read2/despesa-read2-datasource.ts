...
const EXAMPLE_DATA: Despesa[] = [
  { type: 'Hydrogen', description: 'd', value: 12.3, date: '23'},
  { type: 'Hydrogen', description: 'd', value: 12.3, date: '23'},
  { type: 'Hydrogen', description: 'd', value: 12.3, date: '23'},
  { type: 'Hydrogen', description: 'd', value: 12.3, date: '23'},
...
export class DespesaRead2DataSource extends DataSource<Despesa> {
   ...
   */
  private getPagedData(data: Despesa[]): Despesa[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: Despesa[]): Despesa[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        ...
        case 'id': return compare(+a.type, +b.type, isAsc);
        default: return 0;
      }
    });
  }
